...
SECTIONS: list[SectionSpec] = [
    SectionSpec(
        ...
        [
            ...
            LessonSpec(
                "A Brief History of Django and Why It Still Wins in 2026", "video", is_preview=True
            ),
    ...
    SectionSpec(
        ...
        [
            ...
            LessonSpec(
                "Section Assignment: Refactor a Script Using Classes and Decorators", "assignment"
            ),
    ...
    SectionSpec(
        ...
        [
            ...
            LessonSpec(
                "Section Assignment: Add Caching and Signals to Your Capstone", "assignment"
            ),
        ...
        [
            ...
            QuestionSpec(
                ...
                [
                    ...
                    "To compile Python into machine code",
                    "To replace pip entirely",
                    "To run Django in production automatically",
                ],
                0,
            ...
            QuestionSpec(
                ...
                [
                    "Writes installed package versions to a file",
            ...
            QuestionSpec(
                ...
                [
                    "It's a batteries-included framework with an ORM, admin, and security defaults built in",
                    "It only supports NoSQL databases",
                    "It requires no third-party packages ever",
                    "It cannot be deployed with Docker",
                ],
                0,
    ...
    QuizSpec(
        ...
        [
            ...
            QuestionSpec(
                ...
                [
                    "Inherits blocks from a parent template",
            ...
            QuestionSpec(
                ...
                [
                    "CBVs organize HTTP-method handling into methods on a class; FBVs use a single function",
                    "FBVs cannot render templates",
                    "CBVs cannot access request.POST",
    ...
    QuizSpec(
        ...
        [
            ...
            QuestionSpec(
                ...
                [
                    "Deletes related rows when the referenced row is deleted",
                    "Prevents deletion of the referenced row",
                    "Sets the field to NULL on delete",
                    "Archives the row instead of deleting",
                ],
                0,
            ...
            QuestionSpec(
                ...
                [
                    "Encapsulating reusable query logic on a model",
    ...
    QuizSpec(
        ...
        [
            ...
            QuestionSpec(
                ...
                [
                    "Bulk-assigning the same set of permissions to many users",
                    "Grouping templates together",
                    "Grouping URL patterns",
                    "Grouping database migrations",
                ],
                0,
    ...
    QuizSpec(
        ...
        [
            ...
            QuestionSpec(
                ...
                [
                    "Running bulk operations on selected objects in the list view",
                    "Styling the admin theme",
                    "Creating new URL routes",
            ...
            QuestionSpec(
                ...
                [
                    ...
                    "InlineModelAdmin used directly",
                    "AdminSite",
                    "ModelForm",
                ],
                0,
    ...
    QuizSpec(
        ...
        [
            ...
            QuestionSpec(
                ...
                [
                    "Converts complex data like querysets into JSON and validates incoming data",
                    "Handles URL routing",
            ...
            QuestionSpec(
                ...
                [
                    "PAGE_SIZE (via the pagination class config)",
                    "MAX_RESULTS",
                    "RESULTS_PER_PAGE",
                    "LIMIT",
                ],
            ...
            QuestionSpec(
                ...
                [
                    "Excessive request rates from a single client",
                    "SQL injection",
    ...
    QuizSpec(
        ...
        [
            QuestionSpec(
                ...
                [
                    "Message broker (and often result backend)",
                    "Web server",
                    "Template engine",
                    "ORM replacement",
                ],
            ...
            QuestionSpec(
                ...
                [
                    "So slow I/O doesn't block the HTTP response",
                    "Because Django cannot send emails synchronously",
                    "Because SMTP requires Celery",
                    "Because emails must be encrypted by Celery",
                ],
                0,
            ...
            QuestionSpec(
                ...
                [
                    "Retry with backoff",
                    "Mark it permanently failed immediately",
    ...
    QuizSpec(
        ...
        [
            ...
            QuestionSpec(
                ...
                [
                    "Generating realistic model instances for tests without repetitive boilerplate",
                    "Replacing the Django ORM",
            ...
            QuestionSpec(
                ...
                [
                    "Isolates the test from real network calls and unpredictable third-party behavior",
                    "Makes the test slower but more accurate",
                    "Bypasses all assertions",
            ...
            QuestionSpec(
                ...
                [
                    "A unit test isolates a single component; an integration test exercises multiple components together",
                    "Unit tests always require a database",
                    "Integration tests never use the test client",
                    "There is no meaningful difference",
                ],
                0,
            ...
            QuestionSpec(
                ...
                [
                    ...
                    "Because CI replaces code review",
    ...
    QuizSpec(
        ...
        [
            ...
            QuestionSpec(
                ...
                [
                    "A WSGI application server that runs Django in production",
                    "A reverse proxy",
                    "A database",
                    "A CSS framework",
                ],
            ...
            QuestionSpec(
                ...
                [
                    "To handle static files, SSL termination, and reverse-proxy traffic efficiently",
                    "To replace the Django ORM",
                    "To run Celery tasks",
                    "To compile Python bytecode",
                ],
                0,
            ...
            QuestionSpec(
                ...
                [
                    "Environment variables or a secrets manager, never committed to source control",
            ...
            QuestionSpec(
                ...
                [
                    ...
                    "Only build images, never run them",
            ...
            QuestionSpec(
                ...
                [
                    "Automatically test, build, and deploy code on every change",
                    "Manually FTP files to a server",
    ...
    QuizSpec(
        ...
        [
            QuestionSpec(
                ...
                [
                    "Reducing repeated expensive computation or database load by reusing previous results",
                    "Increasing database writes",
            ...
            QuestionSpec(
                ...
                [
                    "Letting decoupled parts of an app react to an event, like post_save",
                    "Defining URL routes",
                    "Rendering templates",
                    "Running migrations",
                ],
            ...
            QuestionSpec(
                ...
                [
                    ...
                    "Cross-Quadrant Routing Service",
                ],
                0,
            ...
            QuestionSpec(
                ...
                [
                    "Services communicate by publishing and reacting to events rather than direct synchronous calls",
                    "All services must share one database",
                    "Every request must be synchronous",
                    "Events are only used for logging",
                ],
                0,
            ...
            QuestionSpec(
                ...
                [
                    "Hidden, hard-to-trace side effects that make control flow difficult to follow",
                    "They are slower than Celery tasks in all cases",
                    "They cannot be tested",
                    "They only work with class-based views",
                ],
                0,
            ...
            QuestionSpec(
                ...
                [
                    "To detect, diagnose, and resolve production issues quickly",
                    "To make the codebase slower on purpose",
                    "To replace the need for testing",
                    "To avoid needing monitoring dashboards",
                ],
                0,
    ...
    QuizSpec(
        ...
        [
            QuestionSpec(
                ...
                [
                    "An assigned instructor Role/UserRole record, not just being logged in",
                    "Their email domain",
                    "The color of their profile avatar",
                    "Nothing — every user is automatically an instructor",
                ],
                0,
            ...
            QuestionSpec(
                ...
                [
                    "So a third party, like an employer, can verify authenticity via a public link",
                    "To make the PDF file smaller",
                    "To satisfy Celery Beat scheduling",
                    "Because Django requires it for every model",
                ],
                0,
            ...
            QuestionSpec(
                ...
                [
                    ...
                    "It makes the code run without Python installed",
            ...
            QuestionSpec(
                ...
                [
                    "Retrofitting caching after code is tightly coupled to raw queries is more error-prone than designing for it upfront",
                    "Caching is only useful for static files",
                    "Django cannot support caching once models exist",
                    "Caching requires rewriting the ORM",
                ],
                0,
            ...
            QuestionSpec(
                ...
                [
                    "Catching maintainability, security, and consistency issues before they reach production",
            ...
            QuestionSpec(
                ...
                [
                    "Rolling out new code without interrupting service for existing users",
                    "Deploying only at midnight",
                    "Deploying without writing any tests",
                    "Deleting the database before each deploy",
                ],
                0,
...
REVIEWS: list[tuple[int, str]] = [
    (
        5,
        "The capstone project alone is worth the price. I went in only knowing basic Python and came out having deployed a real API with Docker.",
    ),
    (
        5,
        "Best Django course I've taken. The section quizzes actually made me go back and re-watch lessons instead of just clicking through.",
    ),
    (
        4,
        "Really solid, dense course. The Celery section moved a bit fast for me but the practice exercises helped it click.",
    ),
    (
        5,
        "I use the JWT auth lesson almost verbatim in my job now. Explains the 'why' behind each decision, not just the 'how'.",
    ),
    (
        5,
        "Finally a course that treats testing as a first-class citizen instead of an afterthought tacked on at the end.",
    ),
    (4, "Great content overall. Would love an even deeper dive into CQRS in a follow-up course."),
    (
        5,
        "The Django admin section alone saved me hours at work. Customizing list_display and admin actions is something I use weekly now.",
    ),
    (
        5,
        "Went from zero Django knowledge to confidently shipping a DRF API in about six weeks of evening study.",
    ),
    (
        3,
        "Good course but some sections assume a bit more prior Python knowledge than advertised. Still learned a lot.",
    ),
    (
        5,
        "The enterprise architecture section is what sets this apart from every other Django course out there.",
    ),
    (
        5,
        "Loved that every section ends with a real assignment, not just multiple choice. Forces you to actually build.",
    ),
    (
        4,
        "Clear explanations throughout. The deployment section could use a bit more on managed hosting options, but Docker coverage is excellent.",
    ),
    (5, "This is the course I wish existed when I started learning Django three years ago."),
    (
        5,
        "The instructor clearly explains not just Django but how to think about backend architecture in general.",
    ),
    (
        4,
        "Solid from start to finish. The pacing in the ORM section was perfect for me as someone new to SQL concepts.",
    ),
    (
        5,
        "Got the certificate, put it on LinkedIn, and had two recruiters mention it within the week.",
    ),
    (
        5,
        "The coding exercises with hidden test cases were a great touch — felt like a real technical interview.",
    ),
    (
        4,
        "Comprehensive and well structured. Wish there was a bonus section on GraphQL, but that's a minor nitpick.",
    ),
    (
        5,
        "Watching the capstone come together across sections instead of being a separate bolt-on project was genuinely well designed.",
    ),
    (
        5,
        "Worth every dollar. I'd happily pay double for the depth of the enterprise architecture and DRF sections.",
    ),
]
