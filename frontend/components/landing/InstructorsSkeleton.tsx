// Mirrors Instructors' markup exactly (same wrapper classes, same 3-up
// grid) so swapping it out for the real section once the instructor fetch
// resolves doesn't shift layout.
